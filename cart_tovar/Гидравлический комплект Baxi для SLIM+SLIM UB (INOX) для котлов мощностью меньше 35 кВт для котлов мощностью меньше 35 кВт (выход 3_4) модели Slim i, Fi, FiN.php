...
$name_tovar = "Гидравлический комплект Baxi для SLIM+SLIM UB (INOX) для котлов мощностью меньше 35 кВт для котлов мощностью меньше 35 кВт (выход 3/4) модели Slim i, Fi, FiN";
$price_tovar = "21173";
$sklad_tovar = "10 шт";
$description_tovar = "";
$url_img = "../main_img/acsessuary/gidravl_komplekt_dlya_slim_slim_ub_inox_dlya_kotlov_210_300.jpg";
?>
	...
	<div class="main_content">
		<div class="cart">
			...
			<div class="cart_right">
				<div class="cart_img">
					<a href=""><img alt="$name_tovar" src="<?php echo $url_img; ?>"></a>
				</div>
