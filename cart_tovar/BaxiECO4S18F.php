...
$name_tovar = "Baxi ECO4S 18F";
$price_tovar = "43200";
$sklad_tovar = "10 шт";
$description_tovar = "Настенные газовые котлы ECO-4s отличаются компактностью, надежностью и простотой установки, эксплуатации и обслуживания. Модель оснащена гидравлической группой из композитных материалов, раздельными теплообменниками на отопление и ГВС и турбинным датчиком протока-расходомером, который дает потребителю еще больший при использовании горячей водой. Несомненный преимущества котлов ECO-4s является простым и привычным интерфейсом управления через полную информацию о работе котла и расширенную самодиагностику.";
?>
